...
def sum_in_mem (data: List[str]) -> int:
...
def sum_in_mem2 (data: List[str]) -> int:
    zero_mask = '000000000000000000000000000000000000'
    def apply_mask(mask, value):
        value = zero_mask[:len(zero_mask) - len(value) ] + value
        new_value = ['0']*36
...
data = get_data('2020/day14/input.txt')


print("-----")
print("Day 14 problem 1: " + str(sum_in_mem(data)))
print("Day 14 problem 2: " + str(sum_in_mem2(data))) 
print("-----")