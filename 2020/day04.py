...
data = refactor( get_data('data/2020/input04.txt'))
res = list(filter(None, list(map(valid_return, data))))


print("-----")
print("Day 4 problem 1: " + str(sum(list(map(valid, data)))))
print("Day 4 problem 2: " + str(sum(list(map(check_passports, res))))) 
print("-----")
